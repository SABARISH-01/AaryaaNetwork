...
const EditPlan = () => {
  ...
  useEffect(() => {
    const fetchPlan = async () => {
      setLoading(true);
      try {
        const res = await axios.get(`https://aaryaanetwork-backend.onrender.com/api/plans/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`https://aaryaanetwork-backend.onrender.com/api/plans/${id}`, payload,{ withCredentials: true });
