...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchPlans = async () => {
      try {
        const res = await axios.get("https://aaryaanetwork-1.onrender.com/api/plans", { withCredentials: true });
        setPlans(res.data);
    ...
    const fetchRecentChanges = async () => {
      try {
        const res = await axios.get("https://aaryaanetwork-1.onrender.com/api/plans/recent", { withCredentials: true });
